...
if (isset($_POST['id_proveedor'], $_POST['nombre_proveedor'], $_POST['telefono_proveedor'], $_POST['rut_proveedor'], $_POST['tipo_proveedor'])) {
    ...
    $tipo_proveedor_id = $_POST['tipo_proveedor']; // Ahora es el ID del tipo de proveedor
    ...
    if ($stmt = $conn->prepare($query)) {
        $stmt->bind_param("ssssi", $nombre_proveedor, $telefono_proveedor, $rut_proveedor, $tipo_proveedor_id, $id_proveedor);
        $stmt->execute();
